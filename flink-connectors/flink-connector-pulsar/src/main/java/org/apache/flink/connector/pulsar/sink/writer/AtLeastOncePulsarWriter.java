 ...
 */
@Internal
public class AtLeastOncePulsarWriter<IN> extends BasePulsarWriter<IN> {

    private static final Logger LOG = LoggerFactory.getLogger(ExactlyOncePulsarWriter.class);

    public AtLeastOncePulsarWriter(
    ...
    @Override
    protected BiConsumer<MessageId, Throwable> initializeSendCallback(SinkConfiguration sinkConfiguration,
